---
admin-fields:
  title: "Weighted vs Unweighted GPA: Which One Colleges Actually Care About"
...
The College Board's [Big Future course guidance](https://bigfuture.collegeboard.org/plan-for-college/your-high-school-record/courses/9th-and-10th-grade-classes-that-impress-colleges) is explicit that selective colleges weigh course rigor heavily alongside the GPA itself. They want to see students who challenged themselves with what their school offered.
...
**National Honor Society.** [NHS](/blog/nhs-gpa-requirements) and similar academic honor societies often use weighted GPA cutoffs, since they're trying to identify students with both strong grades and rigor.
...
1. **Keep unweighted GPA above the admit-median band for your target schools.** That's the number admissions compares.
2. **Push weighted GPA up by adding AP/Honors courses you can succeed in.** Each additional rigor point helps the rigor signal.
3. **Don't trade unweighted GPA for weighted gains.** A 3.6 unweighted with a 4.5 weighted is worse than a 3.9 unweighted with a 4.3 weighted at most selective colleges.

Run both calculators side by side as you build your course plan. The [weighted GPA calculator](/weighted-gpa-calculator) gives you the rigor-boosted number, the [unweighted GPA calculator](/unweighted-gpa-calculator) gives you the cross-school comparable number, and the [GPA goal calculator](/gpa-goal-calculator) tells you what grades you need next semester to hit a target.

## FAQ

**Which is more important to colleges, weighted or unweighted GPA?**
Unweighted, for benchmarking against admit medians. Weighted (alongside course rigor) for the secondary question of whether you challenged yourself. Most colleges recompute every transcript on their internal scale, so the raw weighted number is informative but rarely decisive.

**Can a weighted GPA be higher than 4.0?**
Yes. The most common scale tops at 5.0. Some districts use a 6.0 scale. The 4.0 ceiling only applies to unweighted GPA.

**Do colleges use weighted GPA for class rank?**
Most high schools compute class rank using weighted GPA. Colleges then read the class rank as reported by your school. The reported rank percentile (top 10%, top 25%) is what colleges use.

**Is a 3.9 unweighted with two APs better than a 4.5 weighted with seven APs?**
For selective college admissions, often yes — but it depends. The 4.5 weighted has a stronger rigor signal but a lower unweighted GPA. Most admissions offices reconstruct both numbers from the transcript and read them together. The better question is "what is the actual unweighted under that 4.5 weighted?" If it's 3.9, you have both. If it's 3.4, the rigor isn't paying off.

**How do I convert weighted GPA back to unweighted?**
You can't, exactly — only your transcript can produce both numbers. The [unweighted GPA calculator](/unweighted-gpa-calculator) will give you the unweighted number from your actual grade list. Going from a weighted GPA backwards isn't reversible because the AP/Honors load is hidden.
