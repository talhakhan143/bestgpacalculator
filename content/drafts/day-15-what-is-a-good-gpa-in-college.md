---
admin-fields:
  title: "What Is a Good GPA in College? Benchmarks for Jobs, Grad School, and Honors"
  slug: "what-is-a-good-gpa-in-college"
...
The honest answer always depends on what you're trying to do next. This post walks through the actual benchmarks colleges, employers, and grad schools use — and what each one means for your post-college plan.
...
1. **Employers** — varies wildly by industry, but 3.0 is the broad floor
2. **Graduate and professional schools** — typically 3.5+ for entry; 3.8+ for top programs
3. **Honors designations** — typically 3.5 cum laude, 3.7 magna, 3.9 summa (varies by school)
...
| Big 4 accounting (Deloitte, PwC, EY, KPMG) | 3.2–3.5+ |
...
| Engineering firms | 3.0–3.5+ |
| Most other private-sector jobs | No GPA filter or 3.0+ |
| Sales, retail management, hospitality | Usually no GPA requirement |

These are first-screen filters. Once a candidate is past the resume-screen stage, GPA matters much less — interview performance and project portfolios dominate. By year 2 of a career, most employers don't ask GPA at all.
...
- If you want to skip the GPA filter entirely, build strong projects, internships, or referrals — they routinely override GPA at smaller companies.
...
- T14 law schools (Yale, Stanford, Harvard, Columbia, etc.): median admit GPA **3.85–3.95**
- Top 15–50: median admit GPA **3.6–3.8**
...
MBA programs care about GPA but weight it differently — work experience and GMAT/GRE scores get more emphasis.

- Top-10 MBA programs (Harvard, Stanford, Wharton, MIT Sloan, etc.): median admit GPA **3.65–3.75**
- Top 11–25 programs: median **3.4–3.6**
...
For PhDs, research experience, recommendations, and fit with potential advisors matter as much or more than GPA. Many top STEM PhD programs admit students with 3.5–3.7 GPAs who have published research papers, while turning down 4.0 students with no research.
...
|---|---|
| UK 2:1 Honours | ≈ 3.3–3.7 US |
| UK First-Class Honours | ≈ 3.85–4.0 US |
| Canadian 3.5/4.3 | ≈ 3.3 US |
| German 1.5/5.0 | ≈ 3.7 US |
| Indian 8.0/10.0 CGPA | ≈ 3.4 US |
...
**1. Take the next semester seriously.** Your remaining semesters carry full weight in the cumulative average. Use the [GPA goal calculator](/gpa-goal-calculator) to see what semester GPAs would close the gap.

**2. Consider [grade replacement](/blog/does-retaking-a-class-replace-gpa).** If your school allows replacing failed or D-grade courses, retaking the worst of them with stronger preparation can move the GPA more than any new course.
...
For the calculation: run your real numbers through the [college GPA calculator](/college-gpa-calculator) to see your current cumulative. Then plug it into the [GPA goal calculator](/gpa-goal-calculator) to see what's needed from here to hit a target.

## FAQ

**Is a 3.0 GPA good in college?**
A 3.0 is the broad "good standing" threshold for most US colleges. It's enough for graduation, most employers' minimum screens, and most state-level grad programs. It's below the median for most top employers, top grad schools, and competitive professional schools.

**Is a 3.5 GPA good?**
For most jobs and graduate programs, 3.5 is competitive. It hits typical cum laude / honors thresholds, qualifies for most scholarships, and clears the floor for Big Tech and Big 4 recruiting. For elite consulting/IB and top professional schools, it's at the lower end of competitive.

**What's the average college GPA?**
Average cumulative undergraduate GPA in the US is approximately 3.15 across all majors, but it varies significantly. STEM majors average closer to 3.05; humanities and education average closer to 3.4.

**Does college GPA still matter after graduation?**
Mostly for the first job. After year 1–2 of a career, employers stop asking. For grad school applications, GPA matters at any point you apply. For professional licensing, GPA usually doesn't matter; passing the licensure exam does.

**What GPA do you need to graduate?**
Most US universities require a 2.0 cumulative GPA to graduate. Some majors and programs require higher (often 2.5 or 3.0 in major-specific courses). Check your specific program's degree requirements.

**Is honors GPA different from regular GPA?**
At most schools, honors is the same calculation as regular cumulative GPA — there's no "honors GPA" separate calculation. The honors designation (cum laude, etc.) is awarded at graduation based on a GPA threshold or class-rank percentage.

## Bottom line

In college, "good" GPA depends on what's next. Roughly: 3.0+ for most jobs, 3.5+ for competitive jobs and most grad programs, 3.7+ for top consulting/finance/medical/law, 3.85+ for elite-tier graduate admissions. Honors thresholds typically sit at 3.5 cum, 3.7 magna, 3.9 summa. Use the [college GPA calculator](/college-gpa-calculator) for your current number and the [GPA goal calculator](/gpa-goal-calculator) to plan how to get where you want.
