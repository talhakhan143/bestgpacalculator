...
const ROUTES: Record<string, RouteMeta> = {
  ...
  "/uk-grade-to-gpa-converter": { lastMod: "2026-06-15", priority: 0.9, changeFrequency: "monthly" },
  "/india-cgpa-to-gpa-converter": { lastMod: "2026-06-16", priority: 0.9, changeFrequency: "monthly" },
